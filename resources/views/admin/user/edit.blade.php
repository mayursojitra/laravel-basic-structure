				...
				<div class="col-sm-12">
					...
					<div class="card">
                        ...
                        <div class="card-block">
                        	<div class=>
                        		<form action=" {{route('admin.user.update',['id' => $user->id])}} " method="post" enctype="multipart/form-data" autocomplete="off">
                        			@csrf
									<?php $count = 1; ?>
                        			<div class="admin-form">
                        				<div class="row mb-3">
                        					...
                        					<div class="col-lg-10">
                        						<div class="m-b-10">
                        							<input type="text" class="form-control" value="{{ $user->name }}"  id="name" placeholder="Name" name="name" tabindex="{{ $count++ }}" required>
                        						</div>
                        					</div>
                                        </div>
                        				<div class="row mb-3">
                        					...
                        					<div class="col-lg-10">
                        						<div class="m-b-10">
                        							<input type="email" class="form-control" value="{{ $user->email }}"  id="email" placeholder="Email" name="email" tabindex="{{ $count++ }}" required>
                        						</div>
                        					</div>
                        				</div>
                        				<div class="row mb-3">
                        					...
                        					<div class="col-lg-10">
                        						<div class="m-b-10">
                        							<input type="number" class="form-control" value="{{ $user->mobile }}"  id="mobile" placeholder="Mobile Number " name="mobile" tabindex="{{ $count++ }}" required>
                        						</div>
                        					</div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="m-b-10">
                                                    <input type="text" class="form-control date-picker" value="{{ $user->dob->format('Y/m/d') }}"  id="dob" name="dob" tabindex="{{ $count++ }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="m-b-10">
                                                    <input type="file" class="form-control" id="profile_photo" name="profile_photo" tabindex="{{ $count++ }}" >
                                                </div>
                                            </div>
                                        </div>
                        				<div class="row mb-3">
                        					...
                        					<div class="col-lg-10">
                        						<div class="m-b-10">
                        							<input type="password" class="form-control" id="password" value="" placeholder="Password" name="password" tabindex="{{ $count++ }}">
                        						</div>
                        					</div>
                        				</div>
                        				<div class="row mb-3">
                        					...
                        					<div class="col-lg-10">
                        						<div class="m-b-10">
                        							<input type="password" class="form-control"  id="password_confirmation" value="" placeholder="Confirm password" name="password_confirmation" tabindex="{{ $count++ }}">
                        						</div>
                        					</div>
                                        </div>
                        				<div class="row mb-3">
                        						...
                        						<div class="col-lg-10">
                        							<div class="row m-b-10">
                        								<div class="col-lg-3 radio radio-inline">
                        									<label><input type="radio" name="status" value="active" tabindex="{{ $count++ }}"  @if($user->status=="active") checked @endif ><i class="helper" style="top:-6px"></i>Enable</label>
                        								</div>
                        								<div class="col-lg-2 radio radio-inline">
                        									<label><input type="radio" name="status" value="disable" tabindex="{{ $count++ }}"  @if ($user->status == "disable") checked @endif><i class="helper" style="top:-6px"></i>Disable</label>
                        								</div>
                        							</div>
                        						</div>
                        					</div>
                        			...
                        			<div class="j-footer row">
                        				<button type="submit" tabindex="17" class="btn btn-primary offset-lg-2 mt-3 waves-effect waves-light">Update User</button>
                        			</div>
                        			<!-- end /.footer -->
